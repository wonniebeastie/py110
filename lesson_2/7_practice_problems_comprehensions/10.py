...
def generate_uuid():
    pattern = [8, 4, 4, 4, 12]
    uuid_list = [generate_segment(num) for num in pattern]
...
print(generate_uuid()) # 86c3669d-d215-86b6-c6a8-c7148028e60e
print(generate_uuid()) # 6658035d-6f59-ffc5-b561-ae0ca5d00528
print(generate_uuid()) # f974ba26-cd35-dd80-823d-c284415bdd19
